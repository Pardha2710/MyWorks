...
public class AdminUsersingle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.child("users").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                Toast.makeText(AdminUsersingle.this, "Not Able To Connect", Toast.LENGTH_LONG).show();
            }
        });
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatabaseReference mPostReference = FirebaseDatabase.getInstance().getReference()
                        .child("users").child(keyval);
                mPostReference.removeValue();

                Intent in = new Intent(AdminUsersingle.this,Adminmain.class);
                startActivity(in);
            }
        });
