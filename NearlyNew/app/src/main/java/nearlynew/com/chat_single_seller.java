...
public class chat_single_seller extends AppCompatActivity {
    ...
    private FirebaseRecyclerAdapter<Chatmessage, chat_single_seller.NewsViewHolder> mPeopleRVAdapter;

    String emailvv,buyermail;
    Button btn;
    EditText et;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buyermail = getIntent().getExtras().getString("buyermail");
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String chat_recev = buyermail;
                String chat_sender = emailvv;
                String chat_emailfull = buyermail+emailvv;
        ...
        String fullemail = buyermail+emailvv;
        ...
        mPeopleRVAdapter = new FirebaseRecyclerAdapter<Chatmessage, chat_single_seller.NewsViewHolder>(personsOptions) {
            ...
            @Override
            protected void onBindViewHolder(chat_single_seller.NewsViewHolder holder, final int position, final Chatmessage model) {
        ...
        mFirebaseDatabase.child(userId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (user == null) {
                    ...
                    Toast.makeText(chat_single_seller.this,"Wishlist NOt added",Toast.LENGTH_LONG).show();
                    return;
                }


                Intent in = new Intent(chat_single_seller.this, chat_single_seller.class);
                in.putExtra("emailval",emailvv);
                in.putExtra("buyermail",buyermail);
                startActivity(in);
    ...
    public void onBackPressed() {
        Intent in = new Intent(chat_single_seller.this,Sellermain.class);
        in.putExtra("emailval",emailvv);
        startActivity(in);
    }
